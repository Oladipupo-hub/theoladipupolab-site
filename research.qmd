...
We are building **environmental-DNA (eDNA) diagnostics** that detect bed bug presence from a simple room swab, before a single insect is visible. The workflow is built for the field rather than the lab (i.e., a short turnaround minimal equipment) that pest management professionals and housing managers can run on-site. In mature form, it converts an invisible problem into an actionable one before it spreads
